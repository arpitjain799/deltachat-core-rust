 ...
 *     it is possible: dc_accounts_add_*account(), dc_accounts_migrate_account(),
 *     dc_accounts_remove_account(), dc_accounts_select_account().
 ...
 *     On errors, NULL is returned.
 */
dc_accounts_t* dc_accounts_new                  (const char* os_name, const char* dir, int writable);
